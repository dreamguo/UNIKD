...
def calc_3d_metric(rec_meshfile, gt_meshfile, align=False):
    ...
    print('Acc:{:.4f} Comp:{:.4f} N_comp:{:.4f} N_acc:{:.4f} N_avg:{:.4f}'.format(accuracy_rec, completion_rec, normal_acc, normal_comp, normal_avg))
    print('CD:{:.4f}\nF1:{:.4f}\nComp_ratio:{:.4f}'.format((accuracy_rec+completion_rec)/2, fscore, completion_ratio_rec))
